const resetSchema = (db) => {
  ...
  ALTER TABLE "messages" ADD CONSTRAINT "messages_conversation_id" FOREIGN KEY("conversation_id") REFERENCES "conversations"("id");
  ALTER TABLE "messages" ADD CONSTRAINT "messages_user_id" FOREIGN KEY("user_id") REFERENCES "users"("id");
  ALTER TABLE "users_channels" ADD CONSTRAINT "users_channels_users_id" FOREIGN KEY("users_id") REFERENCES "users"("id");
  ALTER TABLE "channels" ADD CONSTRAINT "channels_conversation_id" FOREIGN KEY("conversation_id") REFERENCES "conversations"("id");
  ALTER TABLE "channels" ADD CONSTRAINT "channels_user_id" FOREIGN KEY("user_id") REFERENCES "users"("id");
